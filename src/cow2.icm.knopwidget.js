...
$.widget("cow.KnopWidget", {
 ...
 element.append('<div class="knop hoofdknop pointknop "  id="helpbutton" title="Gebruik dit om snel vragen aan anderen te stellen"><span class="   newpoint" newpoint="./images/mapicons/mapicons/comment-map-icon.png"><img width=30 height=30 src="./images/mapicons/mapicons/comment-map-icon.png"></span>');
       
element.append('<div class="knop hoofdknop pointknop "  id="pointbutton" ><span class="   newpoint" newpoint="./images/mapicons/mapicons/comment-map-icon.png"><img width=30 height=30 src="./images/mapicons/mapicons/comment-map-icon.png"></span>');
         element.append('<div class="knop pointsknop subknop">');
        element.append('<div class="sideknop points" style="display:none">');
        $.getJSON('./images/mapicons/progideon_list.js', function(data) {
            
            $.each(data.icons, function(key,val) {
                
                element.find('.points').append('<span class=" sknop  newpoint" newpoint="./images/mapicons/' + val + '"><img width=30 height=30 src="./images/mapicons/'+val+'"></span>');
            });
        });
